...
<div class="right_col" id="cool" role="main">
  ...
  <div class="row">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      ...
      <button data-toggle="modal" data-target="#model_delete_modal" style="float: right; width:10%">Delete Model</button>
      <button data-toggle="modal" data-target="#brand_delete_modal" style="float: right; width:10%">Delete Brand</button>
              ...
              <?php
                 ...
                 foreach($brand_model as $key => $value)
                 {
                  ...
                  <tr>
                   <td>".$value['brand']."</td>
                   <td>".$value['model']."</td>
                   <td><button class='btn btn-info' onclick='open_edit_modal(".$value['brand_id'].")'>Edit</button></td>
                  </tr>";
                 }                 
              ?>
      ...
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body" style="">
           ...
           <select class="form-control" name="model_del">
                  <?php 
