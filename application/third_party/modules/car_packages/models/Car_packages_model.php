<?php
  Class Car_packages_model extends CI_Model
  {
    ...
    {
      $this->db->select('booked_packages.user_id,booked_packages.one_time_service_date,booked_packages.expiry_date,booked_packages.amount,booked_packages.days,booked_packages.package_type,booked_packages.purchase_date,cd.parking_number,cd.type,md.name as model,cb.name as brand');
