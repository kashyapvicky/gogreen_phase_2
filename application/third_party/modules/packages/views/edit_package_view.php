          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <div class="" role="tabpanel" data-example-id="togglable-tabs">
                ...
                <div id="myTabContent" class="tab-content">
                  ...
                  <div class="form-group">
                   ...
                   <div class="col-md-8 col-sm-6 col-xs-12">
                    <input  type="number" class="form-control" value="<?php echo $package_row['interior_thrice']?>" name="interior_thrice" onblur="ext_three_require(this.value)" placeholder="Enter Cost">
                  </div>
                </div>
                <div class="form-group">
                  <div class="control-label col-md-4 col-sm-3 col-xs-12">
              ...
              <div class="form-group">
               ...
               <div class="col-md-8 col-sm-6 col-xs-12">
                <input  type="number" class="form-control" value="<?php echo $package_row['interior_five']?>" name="interior_five" onblur="ext_five_require(this.value)" placeholder="Enter Cost">
              </div>
            </div>
            <div class="form-group">
              <div class="control-label col-md-4 col-sm-3 col-xs-12">
      ...
      <div role="tabpanel" class="tab-pane fade" id="tab_content2" aria-labelledby="profile-tab">
        <div id="whenonce" style="">
          <div class="form-group">
            ...
            <div class="col-md-8 col-sm-6 col-xs-12">
              <input name="interior_cost" required type="number" value="<?php echo $package_row['price_interior']?>" onblur="require_all(this.value)" class="form-control"  placeholder="Enter Cost">
            </div>
          </div>
          <div class="form-group">
            <div class="control-label col-md-4 col-sm-3 col-xs-12">
          ...
          <br>
          <button class="btn btn-primary btn-md btn-save">Update</button>
        </form>
      </div>
    </div>
