      ...
      <div class="x_panel">
        ...
        <div class="x_content">
          ...
          <div class="form-group">
             ...
             <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" onkeyup="get_streets(this.value)" id="street"  class="form-control" placeholder="Enter Street Name">
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input onkeyup="get_cleaners(this.value)" type="text"  class="form-control"  placeholder="Enter Cleaners Name">
