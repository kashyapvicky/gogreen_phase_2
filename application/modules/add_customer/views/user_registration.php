...
<div class="right_col" id="cool" role="main">
  <div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
      ...
      <div class="x_content">
        <form method="post" action="<?php echo base_url()?>add_customer/add_user" id="user_form" data-parsley-validate class="form-horizontal form-label-left">
    ...
    <option data-countryCode="ZW" value="263">Zimbabwe (+263)</option>
            ...
            <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                <!-- <input placeholder="email"  required id="email" class="form-control col-md-7 col-xs-12" type="email" name="email"> -->
...
function  is_phone_exist(number)
{
  ...
  var cc = $('#cc').val();
  //alert(cc);
  var phone_number = "+" + cc + phone_number;
