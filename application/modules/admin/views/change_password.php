                    ...
                    <form id="demo-form2" method="post" action="<?php echo base_url('admin/change_password')?>" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="password" id="first-name" value="<?php echo set_value('current_password')?>" name="current_password" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="password" value="<?php echo set_value('new_password')?>" id="last-name" name="new_password" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Confirm Password*</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="middle-name" value="<?php echo set_value('new_password')?>" class="form-control col-md-7 col-xs-12" type="password" name="confirm_password">
                        </div>
                      </div>
