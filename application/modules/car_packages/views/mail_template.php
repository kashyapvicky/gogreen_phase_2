...
<table class="tablebx">
	...
	<tr>
		<td class="row">Ordered: <i><?php echo date('M-d-Y'); ?><i></td>
	</tr>
	<tr>
		<td>ORDER SUMMARY</td>
	</tr>
	...
	<tr>
		<td>Order Total: <i>AED<?php echo $net_paid ?>.00</i></td>
	</tr>
	<tr>
		<td>Payment: <?php echo $net_paid ?>&nbsp;(In case of COD our team will call you shortly)</td>
	</tr>
...
<table class="tablebx" style="background-color: #eee; margin-top: 7px;">
	...
	<tr>
		<td class="appbtn-wrap">
			<a href="#" class="app-btn"><img src="images/playstore.png" alt="playstore"></a><a href="#" class="app-btn"><img src="images/appstore.png" alt="appstore"></a>
		</td>
	</tr>
	<tr>
