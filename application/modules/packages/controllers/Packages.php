...
//get city for text area ajax function
	...
	public function insert_package()
	{
		...
		else
		{
			...
			else
			{
				 ...
				 $month_1 = $this->input->post('month_1');
				 $month_2 = $this->input->post('month_2');
				 $month_3 = $this->input->post('month_3');
				 $month_4 = $this->input->post('month_4');
				 $month_5 = $this->input->post('month_5');
				 $month_6 = $this->input->post('month_6');
				 $month_7 = $this->input->post('month_7');
				 $month_8 = $this->input->post('month_8');
				 $month_9 = $this->input->post('month_9');
				 $month_10 = $this->input->post('month_10');
				 $month_11 = $this->input->post('month_11');
				 $month_12 = $this->input->post('month_12');
	...
	public function update_package()
	{
		...
		// echo $type; die;
		$package_localities = $this->packages_model->get_all_localities_of_respective_packages($package_id);//this model function is used twice
		...
		{
			$this->packages_model->set_default_status_to_localities($locality_id_array,$type);//this model function is used twice
		}
	...
	public function delete_package()
	{
		...
		$bool = $this->packages_model->del_package($id);
		 ...
		 // echo $this->db->last_query(); die;
		$package_localities = $this->packages_model->get_all_localities_of_respective_packages($id);//this model function is used twice
		$locality_id_array = array_column($package_localities, 'locality_id');
		if(!empty($locality_id_array))
		{
			$this->packages_model->set_default_status_to_localities($locality_id_array,$type);//this model function is used twice
			$this->packages_model->delete_package_locations($id);
		}
