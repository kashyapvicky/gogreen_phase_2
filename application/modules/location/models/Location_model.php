<?php
  Class Location_model extends CI_Model
  {
    ...
    public function inactivte_locality($locality_id)
    {
     ...
     public function inactivte_street($street_id)
    {
      $this->db->set('status',2);
    ...
    {
      $this->db->select('city.name as city,locality.name as locality,st.name as street,st.id,st.payment_type');
    ...
    public function update_street($name,$id,$payment_type)
    {
      $this->db->where('id',$id);
