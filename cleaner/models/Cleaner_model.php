<?php
  Class Cleaner_model extends CI_Model
  {
   ...
   public function get_cleaner_to_edit($cleaner_id)
   {
      ...
      $this->db->select('cl.id,cl.first_name,cl.email,cl.password,cl.last_name,cl.phone_number,cl.city_id as city_id,cl.locality_id as locality_id,ct.name as city,lt.name as locality');
